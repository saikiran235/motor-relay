...
*/
  ...
  */
  #define   NSS           10  /*arduino pro mini or nano*/   // 5   esp32
/*!
  * @def RESET
  * @brief RESET pin for LoRa module
  */
  #define   RESET         9   /*arduino pro mini or nano*/   // 14  esp32
/*!
  * @def DIO0
  * @brief Interrupt pin
  */
  #define   DIO0          2   //2 pin connect to int0//2   /*arduino pro mini or nano*/
...
/*!
  ...
  * @brief Chip select or Slave select
  */
  #define   NSS           18   /*PIN 18 TTGO*/    // 5   /*PIN 5 LOLIN ESP32*/
  /*!
  * @def RESET
  * @brief RESET pin for LoRa module
  */
  #define   RESET         26  /*PIN 26 TTGO*/    //14   /*PIN 14 LOLIN ESP32*/
     /*!
  * @def DIO0
  * @brief Interrupt pin
  */
  #define   DIO0          2   /*PIN 2 TTGO*/     //2    /*PIN 2 LOLIN ESP32*/
...
bool receive_lora_packet  (char *packet_buffer);  
