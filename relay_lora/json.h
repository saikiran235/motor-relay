...
bool  parse_json(char *packet_buffer,const uint8_t packet_buffer_size);   ///void  parse_json(char *packet_buffer,uint8_t packet_buffer_size);
void  create_json_object(char *tx_packet_buffer,const uint8_t tx_packet_buffer_size); ///void  create_json_object(char *tx_packet_buffer, uint8_t tx_packet_buffer_size);


bool  parse_json_gpsdata(char *packet_buffer,const uint8_t packet_buffer_size); 
